...
exports.fetchObjectivesForUserInDateRange = fetchObjectivesForUserInDateRange;
/**
 ...
 */
function fetchObjectivesForUserInDateRange(notion, objectiveDbId, personId, filterDate) {
    return __awaiter(this, void 0, void 0, function () {
        var response, filtered, _i, _a, page, dateInfo, start, end;
        var _b, _c;
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, _a = response.results; _i < _a.length; _i++) {
                        page = _a[_i];
                        dateInfo = (_c = (_b = page.properties) === null || _b === void 0 ? void 0 : _b['日付']) === null || _c === void 0 ? void 0 : _c.date;
                        if (!dateInfo)
                            continue;
